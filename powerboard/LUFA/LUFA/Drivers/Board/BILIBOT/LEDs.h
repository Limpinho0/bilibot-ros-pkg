...
/** \ingroup Group_LEDs
 *  \defgroup Group_LEDs_BILIBOT BILIBOT
 *  \brief Board specific LED driver header for the BILIBOT Powerboard.
 *
 *  Board specific LED driver header for the BILIBOT Powerboard.
 *
 *  @{
 */
